#
#  Be sure to run `pod spec lint LLTestCopy.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    Just a test for copy. It is my first project for Pod.
                   DESC
  ...
  # s.ios.vendored_frameworks = "TestCopy/**/*.framework"
